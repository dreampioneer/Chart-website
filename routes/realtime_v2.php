                                                        ...
                                                        <div class="card-body">
                                                          <div class="">
                                                            ...
                                                            <select class="form-control" id="sel1">
                                                              <option value="https://kirkleymarketing.com/sensor/routes/reports.php" >Fixed</option>
                                                              <option value="https://kirkleymarketing.com/sensor/routes/realtime.php" selected>Real Type</option>
                                                                                                                        </select>
                                                          </div>
                                                        </div>
...
for(var i=1; i<=9; i++) {
  ...
  success: function(data) {
    ...
    newChart.render();
    newChart.axisX[0].set("title", todayDate, true);
  }
});
...
urlmenu.onchange = function() {
  document.location.href = this.value;
      ...
      function updateChart(tableName , chartName , startDate, endDate) {
            ...
            newChart = new CanvasJS.Chart("chartContainer"+newChart, {
              theme: "light2",
              backgroundColor: "black",
              animationEnabled: true,
              zoomEnabled: true,
              title: {
                text: "Sensor "+newChart,
                fontColor: "white",
              },
              axisY: {
                title: "Value",
