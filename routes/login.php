		...
		<div class="limiter">
			<div class="container-login100" style="background-image: url('./../assets/img/bg.jpg');">
				<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
					<form class="login100-form validate-form" action="./actions/auth.php" method="post">
                            ...
                            if(isset($_SESSION['auth_result']) && $_SESSION['auth_result'] == "false") {
                                ...
                                echo
                                    '<div class="container-login100-form-btn">
                                        <div class="alert alert-danger">Please check again name and password!</div>
                                    </div>';
                            }
						...
						<div class="row">
							...
							<div class="col-6">
								<div class="text-right p-t-8 p-b-31">
									<?php
										if(isset($_SESSION['verify_status']) && $_SESSION['verify_status'] == "true")
