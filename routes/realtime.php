                                                        ...
                                                        <div class="card-body">
                                                          <div class="">
                                                            ...
                                                            <select class="form-control" id="sel1">
                                                              <option value="http://trinityaether.com/sensor/routes/reports.php" >Fixed</option>
                                                              <option value="http://trinityaether.com/sensor/routes/realtime.php" selected>Real Type</option>
                                                                                                                        </select>
                                                          </div>
                                                        </div>
                        ...
                        <div class="card card-stats">
                          <div class="card-header card-header-warning card-header-icon">
                            ...
                            <div class="card-body">
                              ...
                              <!--<iframe src="https://trinityaether.com/sensor/routes/table1/plotS1.html" style="width:100%;height:400px;"></iframe>-->
                            </div>
                        ...
                        <div class="card card-stats">
                          <div class="card-header card-header-warning card-header-icon">
                            ...
                            <div class="card-body">
                              ...
                              <!--<iframe src="https://trinityaether.com/sensor/routes/table2/plotS2.html" style="width:100%;height:400px;"></iframe>-->
                            </div>
                          <div class="card-footer d-none">
                            <div class="stats">
                        ...
                        <div class="card card-stats">
                          <div class="card-header card-header-warning card-header-icon">
                            ...
                            <div class="card-body">
                              ...
                              <iframe src="https://trinityaether.com/samrs/live/plotS3/plotS3.html" style="width:100%;height:400px;"></iframe>
                            </div>
                          <div class="card-footer d-none">
                            <div class="stats">
  ...
  document.location.href = this.value;
    ...
    function updateChart1(index = 1) {
        ...
        function updateChart2(index = 1) {
            ...
            function updateChart3(index = 1) {
                
                console.log('From3 - to3 - ' + localStorage.from3 + ' ' + localStorage.to3);
                                    ...
                                    function updateChart9(index = 1) {
                                        ...
                                        $.ajax({
                                          ...
                                          setTimeout(updateChart9, 5000);
                                                                            ...
                                                                            function updateChart10(index = 1) {
