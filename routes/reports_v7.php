                                                        ...
                                                        <div class="card-body">
                                                          <div class="">
                                                            ...
                                                            <select class="form-control" id="sel1">
                                                              <option value="https://kirkleymarketing.com/sensor/routes/reports.php" selected>Fixed</option>
                                                              <option value="https://kirkleymarketing.com/sensor/routes/realtime.php" >Real Type</option>
                                                                                                                        </select>
                                                          </div>
                                                        </div>
