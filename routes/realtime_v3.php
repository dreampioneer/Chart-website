                                                        ...
                                                        <div class="card-body">
                                                          <div class="">
                                                            ...
                                                            <select class="form-control" id="sel1">
                                                              <option value="http://cies-western-eng.ca/sensor/routes/reports.php" selected >Fixed</option>
                                                              <option value="http://cies-western-eng.ca/sensor/routes/realtime.php" >Real Type</option>
                                                                                                                        </select>
                                                          </div>
                                                        </div>
